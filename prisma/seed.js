  ...
  const compatibilityQuestionOption = [
    ...
    },
    {
      ...
      answers: [
        {
          id: 4,
          text: "Igen, nagyon - Jó lenne barátkozni és rendszeresen együtt lógni.",
          value: 0,
        },
    ...
    },
    {
      ...
      answers: [
        {
          id: 7,
          text: "Szeretem, ha élettel teli a lakás - Nem zavar a háttérzaj vagy a gyakori vendégek.",
          value: 0,
        },
        {
          id: 8,
          text: "Néha zavar, néha nem - Nem gond, ha nem túl gyakori vagy hangos.",
          value: 1,
        },
        {
          id: 9,
          text: "Jobban szeretem a csendet - Kevés zajt és ritka vendégeket preferálok.",
          value: 2,
        },
      ],
    },
    {
      ...
      answers: [
        ...
        {
          id: 11,
          text: "Közepesen - Szeretem az egyensúlyt a társaság és a magány között.",
          value: 1,
        },
        {
          id: 12,
    ...
    },
    {
      ...
      answers: [
        ...
        {
          id: 17,
          text: "Attól függ - Megbeszélés után néhány dolgot szívesen megosztok.",
          value: 1,
        },
